          ...
          <Card>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                <textarea
                  className="w-full bg-surface-2 border border-surface-border rounded px-3 py-2 text-sm text-main placeholder:text-slate-500 focus:outline-none focus:border-cyber-cyan resize-none"
                  rows={4}
